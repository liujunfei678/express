...
my_parm={
  ...
  "variables": {
    ...
    "start": 0,
    "queryParams": [],
    "queryName": "getUnbxdCategory"
  },
  "query": "query CategoryQuery($categoryId: String, $start: Int!, $rows: Int, $filter: String, $sort: String, $overrideCatApi: String, $uc_param: String, $queryParams: [String]) {\n  getUnbxdCategory(categoryId: $categoryId, start: $start, rows: $rows, filter: $filter, sort: $sort, overrideCatApi: $overrideCatApi, uc_param: $uc_param, queryParams: $queryParams) {\n    categoryId\n    categoryName\n    facets {\n      facetId\n      name\n      position\n      values\n      valuesWithCount {\n        value\n        count\n        __typename\n      }\n      __typename\n    }\n    pagination {\n      totalProductCount\n      pageNumber\n      pageSize\n      start\n      end\n      __typename\n    }\n    products {\n      availabilityStoreIds\n      averageOverallRating\n      colors {\n        color\n        skuUpc\n        defaultSku\n        defaultSkuUpc\n        imageSet\n        colorFamily\n        __typename\n      }\n      EFOProduct\n      ensembleListPrice\n      ensembleSalePrice\n      key\n      isEnsemble\n      listPrice\n      marketplaceProduct\n      name\n      newProduct\n      onlineExclusive\n      onlineExclusivePromoMsg\n      paginationEnd\n      paginationStart\n      productDescription\n      productId\n      productImage\n      productURL\n      promoArray {\n        ensembleItem\n        promoMessage\n        __typename\n      }\n      promoMessage\n      salePrice\n      totalReviewCount\n      __typename\n    }\n    requestId\n    source\n    sortAlgorithm {\n      sortParamSource\n      algorithm\n      otherSortParams\n      __typename\n    }\n    __typename\n  }\n}\n"
}

def get_url_list(my_parm):
  url_list=[]
  res=requests.post(url=url,headers=header,json=my_parm).text
  js=json.loads(res)
  product_list=js['data']['getUnbxdCategory']['products']
  for p in product_list:
    product_id=p['productId']
    product_url=p['productURL']
    finall_url=base_url+product_url
    url_list.append(finall_url)
    print(product_id)
    print(finall_url)
  return url_list

all_url_list=[]
my_parm['variables']['categoryId']='cat560005'
for i in range(2):
  print(i)
  my_parm['variables']['start']=i*56
  # print(my_parm)
  url_list=get_url_list(my_parm)
  all_url_list=all_url_list+url_list

with open("cat560005.json", "w") as f:
